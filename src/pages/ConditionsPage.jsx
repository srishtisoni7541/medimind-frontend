  ...
  const handleContinue = async () => {
    ...
    try {
      ...
      const response = await fetch(
        `http://localhost:5000/api/condition-details/${conditionName}`,
        {
          method: "GET",
          headers: {
    ...
    <div className="max-w-4xl mx-auto px-4 py-8">
      ...
      <div className="mb-8">
        ...
        <p className="text-gray-600 mb-6">
          Select a condition to learn more details
        </p>
            ...
            userData.conditions.map((condition) => (
              ...
              >
                <div className="p-5">
                  ...
                  <button
                    onClick={() => speakText(condition.description)}
                    className="mt-3 text-sm text-teal-600 underline hover:text-teal-800"
                  >
                    🔊 Hear Description
                  </button>
                </div>
