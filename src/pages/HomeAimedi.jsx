...
const HomeAimedi = () => {
  return (
    <div className="min-h-scree n bg-gradient-to-br from-blue-50 mt-24 to-white">
      <div className="container mx-auto px-4 py-12">
        <header className="text-center mb-12">
          <h1 className="text-4xl font-bold text-[#1D4ED9]  mb-2">Drugs & Medications A-Z</h1>
        ...
        <div className="bg-white rounded-xl shadow-md p-6 mb-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-6">
            <button className="text-left text-[#1D4ED9] flex items-center">
              <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 9l-7 7-7-7" />
              </svg>
              Search Medications by Letter
            </button>
            <button className="text-left text-[#1D4ED9]">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8 mb-12">
          <div className="flex flex-col items-center">
            <div className="w-16 h-16 rounded-full bg-blue-100 flex items-center justify-center mb-3">
              <svg xmlns="http://www.w3.org/2000/svg" className="h-8 w-8 text-[#1D4ED9]" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        <div className="bg-white rounded-xl shadow-md p-6">
          <h3 className="text-lg font-semibold text-[#1D4ED9] mb-4">MORE ON DRUGS & MEDICATIONS</h3>
